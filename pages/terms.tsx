    ...
    <Layout title={'Terms of Service' + commonData.commonTitle} path="terms">
      <div className={styles.tos_container}>
        ...
        <div className={styles.tos_content}>
          ...
          authority to bind such entity to this Agreement. By accessing our
          Service, you agree that you have read, understood and accepted this
          Agreement.
          <br />
          ...
          <br />
          <div>3. Copyright and Limited License</div>
          ...
          <br />
          <div>5. Assumption of Risk, Limitations on Liability.</div>
          ...
          brute forcing or other means of attack against the Service or
          Services.
          <br />
          <br />
          ...
          <br />
          <div>6. No Liability for Third-Party Services and Content</div>
          ...
          <br />
          <div>7. Account Registration</div>
          ...
          transactions.
          <br />
          <div>9. Discontinuation of Services.</div>
          ...
          the contact information below: Copyright Agent
          <br />
          DECOMPANY GLOBAL, Inc.
          <br />
          ...
          apply to you.
          <br />
          <div>15. Limitation of liability</div>
          To the fullest extent permitted by applicable law, in no event shall
          DECOMPANY GLOBAL, Inc. or the any related party to DECOMPANY GLOBAL,
          ...
          <br />
          <div>16. Modifications to the Service</div>
          ...
          you can seek relief from DECOMPANY GLOBAL, Inc. If you do not agree
          ...
          you and DECOMPANY GLOBAL, Inc.: (a) waive your right to have any and
          ...
          waive your right to a jury trial. Instead, you and DECOMPANY GLOBAL,
          ...
          You agree that any dispute is personal to you and DECOMPANY GLOBAL,
          ...
          DECOMPANY GLOBAL, Inc. agree that a dispute cannot be brought as a
          ...
          applicable law.
          <br />
          <div>18. Applicable Law and Venue</div>
