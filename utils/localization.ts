...
const strings = new Map([
  ...
  [
    'event-step1-subj',
    {
      KOR: '폴라리스쉐어 오픈 베타 테스터 모집',
      ENG: '폴라리스쉐어 오픈 베타 테스터 모집'
    }
  ],
  [
  ...
  [
    'event-step1-point',
    {
      KOR: '하드디스크 속 잠자고 있는 나만의 지식을 공유하고 리워드 받자!',
      ENG: '하드디스크 속 잠자고 있는 나만의 지식을 공유하고 리워드 받자!'
    }
  ],
  [
    'event-step1-description',
    {
      KOR:
        '폴라리스쉐어에 여러분의 지식을 공유하고, 추천을 받으신 분들에게 리워드를 드립니다. 폴라리스쉐어가 꿈꾸는 세상의 모든 지식을 공유하는 첫 발걸음을 함께해주세요.',
      ENG:
        '폴라리스쉐어에 여러분의 지식을 공유하고, 추천을 받으신 분들에게 리워드를 드립니다. 폴라리스쉐어가 꿈꾸는 세상의 모든 지식을 공유하는 첫 발걸음을 함께해주세요.'
    }
  ],
  [
    'event-step1-ul-list1',
    {
      KOR:
        '- 모집기간 : 2021년 7월 15일 - 7월 24일',
      ENG:
        '- 모집기간 : 2021년 7월 15일 - 7월 24일'
    }
  ],
  [
    'event-step1-ul-list2',
    {
      KOR:
        '- 테스트 기간: 2021년 7월 26일 - 8월 25일',
      ENG:
        '- 테스트 기간: 2021년 7월 26일 - 8월 25일'
    }
  ],
  [
    'event-step1-ul-list3',
    {
      KOR:
        '- 참여방법: www.polarishare.com 홈페이지를 통해 지원',
      ENG:
        '- 참여방법: www.polarishare.com 홈페이지를 통해 지원'
    }
  ],
  [
    'event-step1-ul2-point',
    {
      KOR:
        '테스터 리워드',
      ENG:
  ...
  [
    'event-step1-ul2-list3',
    {
      KOR:
        '- 폴라 인사이더 프로그램 (향후 폴라리스쉐어의 다양한 서비스를 우선 체험 가능한 프리 패스)',
      ENG:
        '- 폴라 인사이더 프로그램 (향후 폴라리스쉐어의 다양한 서비스를 우선 체험 가능한 프리 패스)'
    }
  ],
  [
    ...
    {
      KOR:
        '(베타테스터 모집 기간 내 등록 유저에 한해 리워드 지급)',
      ENG:
        '(베타테스터 모집 기간 내 등록 유저에 한해 리워드 지급)'
    }
  ],
  [
    ...
    {
      KOR:
        '(자세한 리워드 및 정산 프로그램은 7월 26일 홈페이지를 통해 공지)',
      ENG:
        '(자세한 리워드 및 정산 프로그램은 7월 26일 홈페이지를 통해 공지)'
    }
  ],
  ...
  [
    'event-step2-description',
    {
      KOR:
        '하기 지원해주신 이메일 / 연락처를 통해 자세한 베타테스터 안내 및 미션, 리워드 프로그램에 대한 안내를 전해드릴 계획입니다.',
      ENG:
        '하기 지원해주신 이메일 / 연락처를 통해 자세한 베타테스터 안내 및 미션, 리워드 프로그램에 대한 안내를 전해드릴 계획입니다.'
    }
  ],
