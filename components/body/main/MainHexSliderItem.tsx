...
import { MainHexSliderItem } from '../../../typings/interfaces'

export default function({
  activeIndex,
  slideIndex
}: MainHexSliderItem): ReactElement {
      ...
      <div className={styles.mhsi_wrapper}>
        ...
        <div className={styles.mhsi_user}>
          <span className={styles.mhsi_userAvatar}>
            <img
              srcSet="../../../public/static/image/main/ico-user.png,
                                        ../../../public/static/image/main/ico-user-m.png 2x"
              src="../../../public/static/image/main/ico-user.png"
              alt=""
            />
          </span>
