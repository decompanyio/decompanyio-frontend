...
export default function Menu({ setMenuClose }: MenuProps): ReactElement {
    ...
    <div className={styles.mn_wrapper}>
      <div className={styles.mn_container}>
        ...
        <div className={styles.mn_contentList}>
          ...
          >
            <div className={styles.mn_contentItem}>{psString('MenuAvatar-5')}</div>
          </a>
          <div className={styles.mn_contentItemSub}>
            <a
