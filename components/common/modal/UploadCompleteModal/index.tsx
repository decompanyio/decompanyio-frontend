...
export default function UploadCompleteModal(): ReactElement {
    ...
    <div className={styles.modal_container}>
      ...
      >
        <div className={styles.modal_title}>
          ...
          <h3>{psString('profileUpload-doc-subj-2')}</h3>
        </div>

        <div className={styles.modal_content}>
          {privateDocumentCount >= 10 ? (
            <div>{psString('profileUpload-doc-desc-3')}</div>
          ) : (
            <div>
              {psString('profileUpload-doc-desc-2') +
                psString('profileUpload-doc-desc-4-a') +
                privateDocumentCount +
                psString('profileUpload-doc-desc-4-b')}
            </div>
          )}
        </div>
