...
import AutoCompleteRenderInput from '../../input/AutoCompleteInput'
import { useMain } from '../../../../redux/main/hooks'
import DocumentInfo from '../../../../service/model/DocumentInfo'

export default function EditDocumentModal(): ReactElement {
        ...
        <div className={styles.modal_content}>
          ...
          <input
            ...
            className={
              styles.edm_input +
              ' ' +
              (titleError.length > 0 ? styles.edm_inputWarning : '')
            }
            value={title}
