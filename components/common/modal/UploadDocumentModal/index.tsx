...
export default function UploadDocumentModal(): ReactElement {
  ...
  const validateFile = (): boolean => {
    setFileInfoError(
      fileInfo.filename === null ? psString('profileUpload-doc-check') : ''
    )
    ...
    <div className={styles.modal_container}>
      ...
      >
        <div className={styles.modal_title}>
          ...
          <h3>{psString('profileUpload-doc-subj')}</h3>
        </div>
        ...
        <div className={styles.modal_content}>
          <input
            ...
            className={
              styles.udm_input +
              ' ' +
              (titleError.length > 0 ? styles.udm_inputWarning : '')
            }
        ...
        <div className={styles.modal_footer}>
          ...
          <div onClick={() => handleUploadBtn()} className={styles.modal_okBtn}>
            {psString('common-modal-profileUpload')}
          </div>
        </div>
