...
import ProfileMyListItem from '../ProfileMyListItem'
import Pagination from '../../../common/Pagination'
import commonData from '../../../../common/commonData'
import {
  contentsListIDList,
  documentPagination,
  ProfileMyListTabProps
...
export default function ProfileMyListTab({
  profileInfo
}: ProfileMyListTabProps): ReactElement {
